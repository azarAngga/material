...
export class ChoserPage {
  lastImage: string = null;
  loading: Loading;
 
  constructor(private fileChooser: FileChooser,public TransferObject: FileTransferObject,public navCtrl: NavController,private transfer: FileTransfer, private camera: Camera, private file: File, private filePath: FilePath, public actionSheetCtrl: ActionSheetController, public toastCtrl: ToastController, public platform: Platform, public loadingCtrl: LoadingController) { }
...
fileGet(){
	this.fileChooser.open()
  		.then(uri => {
			  ...
			  .catch(err => { this.loading.dismissAll()
				    this.presentToast('Error file path');});
  		})
  		.catch(e => { this.loading.dismissAll()
				    this.presentToast('error uri');});
}
